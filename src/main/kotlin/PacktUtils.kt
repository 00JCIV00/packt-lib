...
fun ByteArray.toNumber(): ULong {
	class NoNumberConversionException(message: String = "No number conversion for this ByteArray. The size of the ByteArray is greater than 8 bytes."): Exception(message)
